        ...
        <div className="px-4 pt-3 pb-2">
          {editing ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="flex-1 text-sm font-bold text-white truncate min-w-0">{column.name}</span>
              <span className="text-xs font-semibold px-2 py-0.5 rounded-full text-white/60 bg-white/10 shrink-0">{tasks.length}</span>
              ...
              {confirmDelete ? (
                <div className="hidden md:flex items-center gap-1">
                  <button onClick={handleDelete} className="px-2 py-1 text-xs font-semibold bg-red-500 hover:bg-red-400 text-white rounded-lg transition-colors active:scale-95">Sí</button>
                  <button onClick={() => setConfirmDelete(false)} className="px-2 py-1 text-xs font-semibold bg-white/10 hover:bg-white/20 text-white/70 rounded-lg transition-colors active:scale-95">No</button>
                </div>
              ) : (
                <button
