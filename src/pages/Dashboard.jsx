  ...
  return (
    <div className="flex h-screen bg-white overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto">
        {activeNote ? (
          // key={activeNoteId} es CRÍTICO:
          // fuerza a React a desmontar y remontar NoteEditor al cambiar de nota.
          // Sin esto, el componente se reusaría y TipTap mostraría el contenido anterior.
